  ...
  return (
    <div className="overflow-hidden">
      ...
      <div className="flex w-full justify-center bg-secondary-900">
        <div className="mb-3 flex max-w-7xl items-center justify-center px-3 py-24 max-xl:px-3 max-lg:w-[31rem] max-lg:flex-col max-lg:gap-2 max-lg:overflow-hidden">
